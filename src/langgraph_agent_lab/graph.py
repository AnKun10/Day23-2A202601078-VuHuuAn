...
def build_graph(checkpointer: Any | None = None):
    ...
    # 1. Register all 11 nodes (registered name == string returned by routers).
    ...
    # 3. Conditional edges (branch targets must be registered node names).
    ...
    # 4. Compile with the (optional) checkpointer for persistence.
